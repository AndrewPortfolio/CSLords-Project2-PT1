...
def forward_selection(num_features): 
    ...
    print("Using 0 features and \"random\" eval accuracy is ", base_acc)
    ...
    for level in range(1,num_features + 1):  
        ...
        for feature in range(1, num_features + 1): 
            if feature not in ans_set: 
                ...
                print("    Using feature(s) ", curr_set, " accuracy is ", accuracy)
        ...
        print("Feature set ", ans_set, " was the best with an accuracy of ", best_acc_so_far, "\n")
    ...
    print("Finished Search!! The best feature subset is ", best_set, "with an accuracy of ", best_acc)
